import { COMPANY_NAME, COMPANY_NAME_SIGNATURE, COMPANY_SIGNATORY } from '@/lib/company';
import { fmtDate, money } from '@/lib/format';
import type { Payslip, SheetDate } from '@/lib/types';

// Faithful HTML replica of the payslip Maya has been sending for years
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-x-10 mt-8">
        <div>
          ...
          <div className="mt-14">{COMPANY_SIGNATORY}</div>
          <div>{COMPANY_NAME_SIGNATURE}</div>
        </div>
