...
export default function CutoffForm({
  ...
  useEffect(() => {
    const d: ComputeDraft = { periodStart, periodEnd, disbursement, restDays, ridePax, ride2Pax, fortPax, serviceCharge, horsePax, tipBox, perEmp };
    writeDraft(d);
  }, [periodStart, periodEnd, disbursement, restDays, ridePax, ride2Pax, fortPax, serviceCharge, horsePax, tipBox, perEmp]);
